...
def M2():
    ...
    h0 = tf.keras.layers.Conv2D(filters=4, kernel_size=(1,1), activation='relu')(input_img)
...
def M3():
    ...
    h0 = tf.keras.layers.Conv2D(filters=8, kernel_size=(1,1), activation='relu')(input_img)
    h0 = tf.keras.layers.MaxPool2D((1,1))(h0) 

    h1 = tf.keras.layers.Conv2D(filters=8, kernel_size=(5,5), padding='same', activation='relu')(h0)
    h1 = tf.keras.layers.MaxPool2D((2,2))(h1)

    h2 = tf.keras.layers.Conv2D(filters=8, kernel_size=(3,3), padding='same', activation='relu')(h1)
    h2 = tf.keras.layers.MaxPool2D((2,2))(h2)

    h3 = tf.keras.layers.Conv2D(filters=8, kernel_size=(3,3), padding='same', activation='relu')(h2)
    h3 = tf.keras.layers.MaxPool2D((2,2))(h3)

    h4 = tf.keras.layers.Conv2D(filters=8, kernel_size=(3,3), padding='same', activation='relu')(h3)
...
def M4():
    global y_pred
    h0 = tf.keras.layers.Conv2D(filters=16, kernel_size=(5,5), activation='relu')(input_img)


    h1 = tf.keras.layers.Conv2D(filters=32, kernel_size=(3,3), padding='same', activation='relu')(h0)
    h1 = tf.keras.layers.AvgPool2D((3,3))(h1)

    h2 = tf.keras.layers.Conv2D(filters=64, kernel_size=(3,3), padding='same', activation='relu')(h1)
    h2 = tf.keras.layers.MaxPool2D((2,2))(h2)

    h3 = tf.keras.layers.Conv2D(filters=16, kernel_size=(3,3), padding='same', activation='relu')(h2)
    h3 = tf.keras.layers.MaxPool2D((2,2))(h3)
...
def E2():
    ...
    h0 = tf.keras.layers.Activation('relu')(h0)
    h0 = tf.keras.layers.MaxPool2D((2,2))(h0)
...
sampler_augmented_spins = data_augmenter_spins.flow(x_full, y_full, batch_size=BATCH_SIZE)
sampler_augmented_brightness = data_augmented_brightness.flow(x_full, y_full, batch_size=BATCH_SIZE)
sampler_augmented_mixed = data_augmented_mixed.flow(x_full, y_full, batch_size=BATCH_SIZE)
# model.summary()
